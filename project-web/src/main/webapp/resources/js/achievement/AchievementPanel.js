...
Ext.project.AchievementPanel = new Ext.extend(Ext.Panel, {
	...
	constructor : function(config) {
		...
		this.store = new Ext.data.JsonStore({
			...
			fields : ['id','name'/*,'type'*/,'annual','leader','rank', 'count'],
            data: {
                "results" : 4,
                "rows" : [
                    {id: '1',name: '铁道供电技术',type: '教学成果',annual : '2018',leader: '张三',rank: '国家级',count: '10'/*,moment: '15'*/},
                    {id: '2',name: '机械制造与自动化',type: '科研成果',annual : '2017',leader: '王五',rank: '省级',count: '15'},
                    {id: '3',name: '数控技术',type: '教学成果',annual : '2016',leader: '老六',rank: '校级',count: '18'},
                    {id: '4',name: '铁道通信与信息化技术',type: '科技成果',annual : '2015',leader: '赵四',rank: '独创',count: '13'}
                ]
            },
            autoLoad:true
		});
