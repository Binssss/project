	...
	constructor : function(config) {
		...
		this.store = new Ext.data.JsonStore({
			...
			fields : ['id','name',{
                ...
                type : 'date',
                dateFormat : 'time'
            },'budget', 'projectType', 'leader','rank','index'],
            data: {
                "results" : 4,
                "rows" : [
                    {id: '1',name: '数控技术',annual: '1522339200000',budget: '8',projectType: '教育教学改革',leader: '张三',rank: '省级',index:"15"},
                    {id: '2',name: '铁道通信技术',annual: '1521129600000',budget: '6',projectType: '教师发展',leader: '王五',rank: '国家级',index:"12"},
                    {id: '3',name: '城市轨道交通技术',annual: '1522339200000',budget: '10',projectType: '教学条件',leader: '赵四',rank: '省级',index:"8"},
                    {id: '4',name: '商务英语',annual: '1521129600000',budget: '6',projectType: '对外交流与合作',leader: '李六',rank: '国家级',index:"15"}
                ]
            },
            autoLoad:true
