Ext.ns('Ext.project');
Ext.project.QuarterTaskPanel = new Ext.extend(Ext.Panel, {
	projectId : null,
    actionJson : null,
	constructor : function(config) {
		...
		this.store = new Ext.data.JsonStore({
			...
			fields : ['id','name','annual','difficulty','leader', 'quarter'/*, 'supportFinish'*/,'actualFinish'],
            data: {
                "results" : 4,
                "rows" : [
                    {id: '1',name: '数控技术',annual: '2018',difficulty:'掌握数控技术',leader: '张三',quarter: '第一季度'/*,supportFinish: '国家级标志性成果1项'*/,actualFinish: '校级标志性成果1项'},
                    {id: '2',name: '铁道通信技术',annual: '2017',difficulty:'熟悉通信',leader: '王五',quarter: '第二季度'/*,supportFinish: '校级标志性成果1项'*/,actualFinish: '国家级标志性成果1项'},
                    {id: '3',name: '城市轨道交通技术',annual: '2016',difficulty:'熟悉交通技术',leader: '赵四',quarter: '第三季度'/*,supportFinish: '省级标志性成果1项'*/,actualFinish: '国家级标志性成果1项'},
                    {id: '4',name: '商务英语',annual: '2015',difficulty:'熟练英文6级',leader: '李六',quarter: '第四季度'/*,supportFinish: '省级标志性成果1项'*/,actualFinish: '国家级标志性成果1项'}
                ]
            },
            autoLoad:true
        ...
        Ext.project.QuarterTaskPanel.superclass.constructor.call(this,{
            layout : 'border',
	...
	showInsertWindow : function() {
		if(this.projectId == null){
            ...
            if (this.addQuarterTaskWindow == null) {
                this.addQuarterTaskWindow = new Ext.project.QuarterTaskWindow({
                    saveUrl : this.Url.insertUrl,
                    store : this.store,
                    projectId : this.projectId
                });
                this.addQuarterTaskWindow.setTitle('新增完成情况');
            }
            this.addQuarterTaskWindow.show();
            this.addQuarterTaskWindow.reset();
		}
	...
	showUpdateWindow : function() {
		...
		if (this.updateQuarterTaskWindow == null) {
			this.updateQuarterTaskWindow = new Ext.project.QuarterTaskWindow({
				saveUrl : this.Url.updateUrl,
				store : this.store
			});
			this.updateQuarterTaskWindow.setTitle('修改完成情况');
		}
		this.updateQuarterTaskWindow.show();
		this.updateQuarterTaskWindow.reset();
		this.updateQuarterTaskWindow.loadRecord(records[0]);
