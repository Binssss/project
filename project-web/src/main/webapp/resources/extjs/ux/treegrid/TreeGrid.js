...
Ext.ux.tree.TreeGrid = Ext.extend(Ext.tree.TreePanel, {
    ...
    handleHdDown : function(e, t){
        ...
        if(hd && Ext.fly(t).hasClass('x-grid3-hd-btn')){
            var ms = this.hmenu.items;
                cs = this.columns;
                this.currentIndex = this.findHeaderIndex(hd),
                c = cs[this.currentIndex];
                sort = c.sortable;
                
            e.stopEvent();
            Ext.fly(hd).addClass('x-grid3-hd-menu-open');
            this.hdCtxIndex = this.currentIndex;
            
            this.fireEvent('headerbuttonclick', ms, c, hd, this.currentIndex);
    ...
    handleHdOver : function(e, t){                    
        ...
        if(hd && !this.headersDisabled){
            this.currentIndex = this.findHeaderIndex(hd);
            this.activeHdRef = t;
            this.activeHdIndex = this.currentIndex;
            var el = Ext.get(hd);
